...
public class XMLThreadItemParser implements ContentHandler, ErrorHandler {
	// ~ Instance fields
	// --------------------------------------------------------
	...
	private XMLThreadItem item = null;
	 ...
	 *            lucene index writer
	 */
	public XMLThreadItemParser(XMLReader xmlReader) {
		saxReader = xmlReader;
