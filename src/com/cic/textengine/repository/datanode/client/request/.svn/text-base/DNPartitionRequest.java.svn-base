...
public abstract class DNPartitionRequest extends DNDaemonRequest {
	int year, month;
	String siteID, forumID;

	abstract void readPartitionRequestBody(DataInputStream dis) throws IOException;
	abstract void writePartitionRequestBody(DataOutputStream dos) throws IOException;
